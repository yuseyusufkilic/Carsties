...
namespace Carsties.AuctionAPI.Data
{
    public class DbInitializer
    {
        ...
        {
            using var scope = app.Services.CreateScope(); //another scope of startup register created in here with this.
        ...
        {
            dbContext.Database.Migrate(); // apply if missing migrations are exists and create db if it is not exist.
            if (dbContext.Auctions.Any())
            {
                Console.WriteLine("Already have seed data- skipping seed data");
                return;
